...
###Step 3. Merges the Training and the Test Sets to Create One Dataset
...
###Step 6. Labels the Dataset with Descriptive Variable Names
...
###Step 7. Creates Additional and Independent Tidy Dataset with the Average of Each Variable for Each Activity and Each Subject
